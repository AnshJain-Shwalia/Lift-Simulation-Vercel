...
const calculateReachabilityFactor = (floor: number, lS: liftState): number => {
    ...
    if (lS.state === 0) {
        ...
        if (lS.movement === 0) {
            ...
            if (
                ...
                lSCopy.state = 2;
                lSCopy.ohc = 0;
                return calculateReachabilityFactor(floor, lSCopy) + 0;
            }
        ...
        if (lS.movement === 1) {
            ...
            return (
                calculateReachabilityFactor(floor, lSCopy) +
...
export default calculateReachabilityFactor;
